...
class DatePicker extends Component {
        ...
        if (isAndroid) {
            try {
                ...
                if (action !== DatePickerAndroid.dismissedAction) {
                    this.setState(() => ({ date: newDate, startDate: date }))
    ...
    getDateObj = () => {
        ...
        const newDate = date || this.props.startDate
        return {
            date: newDate,
            year: newDate ? newDate.getFullYear() : '',
            day: newDate ? `${newDate.getDate()}`.padStart(2, '0') : '',
            month: newDate ? `${newDate.getMonth() + 1}`.padStart(2, '0') : ''
        }
    }
