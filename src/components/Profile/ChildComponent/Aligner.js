...
import {ScrollContainer, Button, Clickable, MainContainer} from '../../common';
...
class Aligner extends Component {
  ...
  render() {
    return (
      <View style={CommonStyles.flex1style}>
        <ImageBackground
          ...
          //   resizeMode="contain"
          imageStyle={{marginTop: '34%', height: '80%', alignSelf: 'center'}}
          style={{
            width: '100%',
            height: '100%',
    ...
    bottom: 80, alignSelf: 'center'}}>
            <Button
              style={{marginTop: 44, marginBottom: 44, fontSize: 8}}
              onPress={() => {
                this.props.navigation.navigate('PatientQuestion');
              }}
              title={'SETUP NEW TREATMMENT'}></Button>
          </View>
          <RenderFooter
                    typeImage={1}
                >
