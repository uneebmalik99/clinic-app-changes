...
class SelfieFrontUpperJawSupervision extends Component {
    ...
    _sendImageUpload() {
        ...
        form.append('selfie_type', 3);
        form.append('title', this.state.title);
       
        form.append("image", {
            uri: this.state.imagePath,
            type: "image/jpeg",
            // name: this.state.orderid+"photo.jpg"
            name: this.state.email+'_'+this.state.aligner+"_UpperJaw_"+new Date().toLocaleString()+"photo.jpg"
    ...
    salesapicall2(urlimg,token2, type){
        ...
        this.props.navigation.navigate('SelfiesFrontViewMandilarSupervision',{
    ...
    render() {
       ...
       <View style={{flex:1}}>
          <View style={{ ...CommonStyles.flex1style, ...Styles.mainContainer, backgroundColor: Colors.BG_Pink }}>
            <ScrollView>
                    <View style={Styles.container}>
                        <Image source={this.state.imagePath == null ? Images.TeethUperjawSupervision : { uri: this.state.imagePath }} style={{ flex: 1, marginVertical: 20, height: 240, width: '95%' }} resizeMode={'cover'}></Image>
                        <Text style={Styles.txtTitle}> {strings.teeth3Title}</Text>
                        <Text style={Styles.txtDesc}> {strings.teeth3Desc}</Text>
                        {this.renderElement()}
                    </View>
                </ScrollView>
        ...
        <Clickable
          ...
          onPress={() => {
            this.props.navigation.navigate('SelfieFrontUpperJawSupervision')
...
export default SelfieFrontUpperJawSupervision;
