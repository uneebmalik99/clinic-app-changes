...
class LaterallyClosedRightSide extends Component {
    ...
    _sendImageUpload(){
        ...
        form.append("image", {
            ...
            name: this.state.orderid+'_'+this.state.aligner+"_6_"+new Date().toLocaleString()+"photo.jpg"
    ...
    salesapicall2(urlimg,token2, type){
        ...
        if(this.state.title == "Before Treatment Selfies"){
        ...
        //    Navigator.resetNavigation('Theethselfies')
       }
            // this.setState({ isLoading: false })
          })
          .catch((error) => {
           ...
           <View style={{ ...CommonStyles.flex1style, ...Styles.mainContainer, backgroundColor: Colors.BG_Pink }}>
            <ScrollView>
                      <View style={Styles.container}>
                        <Image source={this.state.imagePath == null ? Images.TeethLaterallyClosedRightSide : { uri: this.state.imagePath }} style={{ flex: 1,  marginVertical: 20, height: 240, width: '95%' }} resizeMode={'contain'}></Image>
                        <Text style={Styles.txtTitle}> {strings.teeth6Title}</Text>
                        <Text style={Styles.txtDesc}> {strings.teeth6Desc}</Text>
                        {this.renderElement()}
                    </View>
                </ScrollView>
...
export default LaterallyClosedRightSide;
