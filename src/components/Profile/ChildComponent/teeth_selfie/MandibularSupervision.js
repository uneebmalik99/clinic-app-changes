...
class SelfiesFrontViewMandilarSupervision extends Component {
          ...
          <View style={{flex:1}}>
            ...
            <ScrollView>
                  <View style={Styles.container}>
                        <Image source={this.state.imagePath == null ? Images.TeethMandibularSupervision : { uri: this.state.imagePath }}  style={{ flex: 1,  marginVertical: 20, height: 240, width: '95%' }} resizeMode={'contain'}></Image>
                        <Text style={Styles.txtTitle}> {strings.teeth4Title}</Text>
                        <Text style={Styles.txtDesc}> {strings.teeth4Desc}</Text>
                        {this.renderElement()}
                    </View>
                </ScrollView>
    ...
    _sendImageUpload(){
        ...
        form.append("image", {
            ...
            name: this.state.email+'_'+this.state.aligner+"_Lower Jaw_"+new Date().toLocaleString()+"photo.jpg"
...
export default SelfiesFrontViewMandilarSupervision;
