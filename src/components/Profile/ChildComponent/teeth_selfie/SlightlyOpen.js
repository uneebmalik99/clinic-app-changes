...
class SelfiesFrontViewSlightlyOpen extends Component {
    ...
    _sendImageUpload(){
        ...
        form.append("image", {
            ...
            name: this.state.email+'_'+this.state.aligner+"_Front view -Slightly open_"+new Date().toLocaleString()+"photo.jpg"
    ...
    salesapicall2(urlimg,token2, type){
        ...
        fetch(url, {
          method: "POST",
          headers: {
            // "Cookie":"BrowserId=zBAnsoWEEeuHMNGfAiLr-w",
           ...
           <View style={{ ...CommonStyles.flex1style, ...Styles.mainContainer, backgroundColor: Colors.BG_Pink }}>
            <ScrollView>
                    ...
                    <View style={Styles.container}>
                        <Image source={this.state.imagePath == null ? Images.FrontTeethSelfiesSlightlyOpen : { uri: this.state.imagePath }}  style={{ flex: 1,  marginVertical: 20, height: 240, width: '95%' }} resizeMode={'contain'}></Image>
                        <Text style={Styles.txtTitle}> {strings.teeth2Title}</Text>
                        <Text style={Styles.txtDesc}> {strings.teeth2Desc}</Text>
                        {this.renderElement()}
                    </View>
                </ScrollView>
...
export default SelfiesFrontViewSlightlyOpen;
